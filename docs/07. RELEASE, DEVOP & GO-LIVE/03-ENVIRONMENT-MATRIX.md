...
Tài liệu hóa environment matrix cho dự án dựa trên source code hiện tại.
...
| Environment | Purpose | URL | Infrastructure | DB | Config | Access | Data policy | Deploy |
|---|---|---|---|---|---|---|---|---|
| Local | Dev | `localhost:8000`, Vite dev | Frappe Bench | Local site DB | env/Settings | Developers | Synthetic only | bench/npm |
| Development | Shared dev | TODO | TODO | TODO | TODO | Dev team | Non-prod | TODO |
| Testing | QA | TODO | TODO | TODO | TODO | QA/dev | Masked data | TODO |
| UAT | User acceptance | TODO | TODO | TODO | TODO | Key users | Approved samples | TODO |
| Staging | Prod-like | TODO | TODO | TODO | TODO | Restricted | Masked/prod-like | TODO |
| Production | Live | TODO | TODO | TODO | TODO | Restricted | Real confidential | TODO |
