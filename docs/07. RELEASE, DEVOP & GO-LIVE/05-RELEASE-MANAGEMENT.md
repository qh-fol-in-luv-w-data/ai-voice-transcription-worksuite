...
Tài liệu hóa release management cho dự án dựa trên source code hiện tại.
...
| Topic | Policy |
|---|---|
| Versioning | TODO: SemVer or date-based version. |
| Release branch | TODO |
| Approval | Business owner + Tech Lead + QA |
| Release note | Use `06-RELEASE-NOTES-TEMPLATE.md` |
| Freeze window | TODO |
| Emergency release | Requires risk/rollback decision |
| Rollback decision | DevOps + Tech Lead + Owner |
