...
Tài liệu hóa go live checklist cho dự án dựa trên source code hiện tại.
...
| Area | Item | Status |
|---|---|---|
| Infrastructure | Frappe/Redis/worker running | TODO |
| Application | SPA route `/aicenter/2as-worksuite` works | TODO |
| Data | DocTypes migrated | TODO |
| Security | Secrets configured, no test keys | TODO |
| Monitoring | Queue/error logs monitored | TODO |
| Backup | Pre-deploy backup complete | TODO |
| Support | Runbook and contacts ready | TODO |
| User | UAT/training completed | TODO |
| Approval | Business sign-off | TODO |
