...
Tài liệu hóa go live plan cho dự án dựa trên source code hiện tại.
...
| Phase | Activity | Owner | Readiness |
|---|---|---|---|
| T-7 | Confirm scope/config/keys | PM/DevOps | TODO |
| T-3 | UAT sign-off and security review | QA/Security | TODO |
| T-1 | Backup and release artifact ready | DevOps | TODO |
| T | Deploy, migrate, smoke test | DevOps/Tech Lead | TODO |
| T+1..T+5 | Hypercare | Support/Dev | TODO |

Rollback trigger: critical auth/data/security/transcription failure without workaround.
