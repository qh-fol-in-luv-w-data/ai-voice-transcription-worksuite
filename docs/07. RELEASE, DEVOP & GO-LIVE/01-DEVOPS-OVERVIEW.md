...
Tài liệu hóa devops overview cho dự án dựa trên source code hiện tại.
...
|---|---|---|
| Repository | Current workspace is Frappe app repo | Remote/branch policy TODO |
| Build frontend | Vite scripts in `frontend/package.json` | Artifact path policy TODO |
| Backend deploy | Frappe app install/migrate via bench | Production method TODO |
| Pipeline | NOT FOUND `.github/workflows` etc. | Need CI/CD |
| Security scan | `security-scan copy.md` exists | Automate scan TODO |
