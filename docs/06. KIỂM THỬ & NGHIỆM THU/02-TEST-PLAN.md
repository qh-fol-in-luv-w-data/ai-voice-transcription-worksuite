...
Tài liệu hóa test plan cho dự án dựa trên source code hiện tại.
...
| Module | Feature | Test type | Owner | Environment | Dependency | Status |
|---|---|---|---|---|---|---|
| Transcription | Upload/process audio | Integration/E2E | QA | Dev/UAT | API keys | Draft |
| Speaker | Enroll/mapping | Integration/UAT | QA | Dev/UAT | Voice sample | Draft |
| Task | Extract/export/sync | Integration/UAT | QA | Dev/UAT | OpenAI/Worksuite | Draft |
| Security | Auth/authorization | Security/API | Security | UAT | Users/roles | Draft |
| Performance | Long audio/chunk queue | Perf | QA/DevOps | Staging | Test audio | TODO |
