...
Tài liệu hóa security test plan cho dự án dựa trên source code hiện tại.
...
| Test | Scope | Tool/Method | Status |
|---|---|---|---|
| SAST | Python/Vue | TODO | TODO |
| Dependency scan | pip/npm | `pip-audit`, `npm audit` TODO | TODO |
| Secret scan | repo/docs | ripgrep/trufflehog TODO | Draft |
| Auth tests | API allow_guest | Manual/API tests | Draft |
| Authorization tests | Meeting owner boundaries | Two-user API tests | Draft |
| File upload tests | type/size/malicious names | API tests | TODO |
| DAST/API security | Frappe routes | OWASP ZAP/Postman | TODO |
