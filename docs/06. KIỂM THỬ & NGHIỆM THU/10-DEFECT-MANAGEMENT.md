...
Tài liệu hóa defect management cho dự án dựa trên source code hiện tại.
...
|---|---|---|---|
| S1 Critical | Core app unavailable/data leak | TODO | Login fails for all users |
| S2 High | Major workflow blocked | TODO | Audio never completes |
| S3 Medium | Workaround exists | TODO | Speaker label incorrect |
| S4 Low | Cosmetic/minor | TODO | UI text typo |

Lifecycle: New -> Triage -> Assigned -> Fixed -> Retest -> Closed/Reopened.
