...
Tài liệu hóa acceptance checklist cho dự án dựa trên source code hiện tại.
...
|---|---|---|
| Functional | Core workflows pass UAT | TODO |
| Non-functional | Performance targets defined/tested | TODO |
| Security | Auth/owner/secret review complete | TODO |
| Data | Retention/privacy agreed | TODO |
| Documentation | Docs reviewed by owner | TODO |
| Deployment | Go-live checklist complete | TODO |
| Training | User guide/training delivered | TODO |
| Support | Runbook/support model accepted | TODO |
