...
Tài liệu hóa communication plan cho dự án dựa trên source code hiện tại.
...
| Đối tượng | Nội dung | Kênh | Tần suất | Người gửi | Người nhận | Escalation |
|---|---|---|---|---|---|---|
| Sponsor | Milestone/risk | TODO | Weekly | PM | Sponsor | Steering |
| Delivery team | Task/blocker | Standup/Git | Daily | PM/Lead | Dev/QA | Tech Lead |
| QA/UAT | Test scope/defect | Tracker | Per cycle | QA Lead | PM/Dev | PM |
| DevOps | Release/deploy | Release note | Per release | Tech Lead | DevOps | Owner |
| End users | UAT/training | Meeting/doc | UAT/Go-live | PM | Users | Support lead |
