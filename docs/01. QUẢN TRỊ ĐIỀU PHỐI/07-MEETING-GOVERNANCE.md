...
Tài liệu hóa meeting governance cho dự án dựa trên source code hiện tại.
...
|---|---|---|---|
| Daily | Gỡ blockers dev/test | Dev, QA, PM | Blocker list |
| Weekly status | Theo dõi scope/risk | PM, Tech Lead, Owner | Status report |
| Sprint planning | Chọn backlog | Squad | Sprint plan |
| Sprint review | Demo tính năng | Stakeholders | Feedback |
| Retrospective | Cải tiến quy trình | Squad | Action items |
| Steering committee | Quyết định scope/risk lớn | Sponsor, PM, Tech Lead | Decision log |
