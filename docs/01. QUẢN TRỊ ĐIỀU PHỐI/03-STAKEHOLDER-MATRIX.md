...
Tài liệu hóa stakeholder matrix cho dự án dựa trên source code hiện tại.
...
| Stakeholder | Vai trò | Ảnh hưởng | Quan tâm | Trách nhiệm | Kênh | Tần suất | RACI |
|---|---|---:|---:|---|---|---|---|
| Business Owner | Phê duyệt mục tiêu nghiệp vụ | High | High | Xác nhận scope/UAT | TODO | Weekly | A |
| Product Manager/BA | Quản lý requirement | High | High | Backlog, acceptance | TODO | Daily/Weekly | R |
| Tech Lead | Kiến trúc/quality | High | High | Review thiết kế và code | Git/Meeting | Daily | R |
| Backend Developer | Frappe/API/AI flow | Medium | High | Implement API/DocType | Git | Daily | R |
| Frontend Developer | Vue SPA | Medium | High | Implement UI | Git | Daily | R |
| QA Lead | Test/UAT | Medium | High | Test plan, defect | TODO | Per sprint | R |
| DevOps | Deploy/monitoring | High | Medium | Env, backup, rollout | TODO | Release | R |
| Security Reviewer | Security assessment | High | Medium | Threat model, scan | TODO | Release | C |
| End User | Sử dụng app | Medium | High | UAT feedback | App/Meeting | UAT | C |
