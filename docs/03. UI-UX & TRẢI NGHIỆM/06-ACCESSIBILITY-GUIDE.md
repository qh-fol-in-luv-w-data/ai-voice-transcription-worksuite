...
Tài liệu hóa accessibility guide cho dự án dựa trên source code hiện tại.
...
|---|---|---|
| Keyboard | Some inputs support Enter/Esc for rename. | TODO: Full keyboard path chưa được test. |
| Focus | Modal buttons exist. | TODO: Focus trap/restore not confirmed. |
| Labels | Element Plus forms likely provide labels where used. | TODO: Audit từng form. |
| Contrast | Dark/light theme overrides present. | TODO: WCAG contrast measurement. |
| ARIA | NOT FOUND custom ARIA strategy. | Needs Review |
| Screen reader | NOT FOUND explicit support. | Needs Review |
