...
Tài liệu hóa support model cho dự án dựa trên source code hiện tại.
...
| Level | Scope | Channel | Hours | SLA | Escalation |
|---|---|---|---|---|---|
| L1 | User guidance, simple login/upload issues | TODO | TODO | TODO | L2 |
| L2 | App config, known errors, UAT defect triage | TODO | TODO | TODO | L3 |
| L3 | Code/AI/provider/debug/deploy | Git/ops channel | TODO | TODO | Vendor/provider |

Vendor support: OpenAI, Google/Gemini, ElevenLabs, HuggingFace, Worksuite admins.
