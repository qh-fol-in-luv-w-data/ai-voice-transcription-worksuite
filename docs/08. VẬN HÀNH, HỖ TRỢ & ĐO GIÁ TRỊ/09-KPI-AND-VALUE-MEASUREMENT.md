---
title: "KPI And Value Measurement"
...
Tài liệu hóa kpi and value measurement cho dự án dựa trên source code hiện tại.
...
| KPI | Type | Formula | Baseline | Target | Data source | Owner |
|---|---|---|---|---|---|---|
| Minutes saved per meeting | Business | manual time - app time | TODO | TODO | UAT survey/logs | Product |
| Meetings processed | Adoption | count meetings | TODO | TODO | `Voice Meeting` | Product |
| Task capture rate | Quality | extracted accepted / expected | TODO | TODO | UAT checklist | QA/BA |
| AI cost per meeting | Cost | token/char cost / meeting | TODO | TODO | VOICE logs/provider billing | Ops |
| Error rate | Technical | failed actions / total | TODO | TODO | logs | DevOps |
