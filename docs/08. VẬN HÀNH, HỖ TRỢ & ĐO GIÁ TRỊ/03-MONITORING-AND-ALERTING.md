...
Tài liệu hóa monitoring and alerting cho dự án dựa trên source code hiện tại.
...
| Component | Metric | Threshold | Severity | Channel | Owner | Response |
|---|---|---|---|---|---|---|
| Frappe web | availability/5xx | TODO | High | TODO | DevOps | Restart/investigate |
| Queue worker | backlog/age | TODO | High | TODO | DevOps | Scale/restart |
| STT/AI provider | error rate/quota | TODO | Medium/High | TODO | DevOps | Retry/fallback |
| DB | slow queries/storage | TODO | High | TODO | DBA/DevOps | Tune/cleanup |
| File storage | disk usage | TODO | High | TODO | DevOps | Cleanup/archive |
| Security | failed auth/webhook spikes | TODO | High | TODO | Security | Investigate |
