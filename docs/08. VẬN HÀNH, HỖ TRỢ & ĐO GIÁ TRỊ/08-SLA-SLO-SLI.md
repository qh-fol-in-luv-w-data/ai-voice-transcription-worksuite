...
Tài liệu hóa sla slo sli cho dự án dựa trên source code hiện tại.
...
| Service | SLI | SLO | SLA | Measurement | Source | Reporting |
|---|---|---|---|---|---|---|
| App availability | successful HTTP requests | TODO | TODO | web logs | Frappe | TODO |
| Transcription | completion success rate/time | TODO | TODO | `Voice Meeting.status` | DB/logs | TODO |
| Task extraction | success rate/time | TODO | TODO | cache/logs | `VOICE AI Call Log` | TODO |
| ERP sync | sync success rate | TODO | TODO | sync report | Worksuite/API | TODO |
