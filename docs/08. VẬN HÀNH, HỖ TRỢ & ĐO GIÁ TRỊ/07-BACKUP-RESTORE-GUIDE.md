...
Tài liệu hóa backup restore guide cho dự án dựa trên source code hiện tại.
...
|---|---|
| Database | Frappe site DB includes DocTypes and settings. |
| Files | public/private files include audio, DOCX, XLSX. |
| Config | site_config, Voice App Settings, env vars. |
| Frequency | TODO: Cần xác nhận. |
| Retention | TODO: Cần xác nhận. |
| Encryption | TODO: Cần xác nhận. |
| Restore | Use standard Frappe restore plus files restore; validate smoke tests. |
