...
Tài liệu hóa incident management cho dự án dựa trên source code hiện tại.
...
| Severity | Detection | Triage | Assignment | Communication | RCA |
|---|---|---|---|---|---|
| SEV-1 | Outage/data exposure | immediate bridge | DevOps/Security | 30 min TODO | Required |
| SEV-2 | Core workflow broken | same business day TODO | Dev/QA | TODO | Required |
| SEV-3 | Degraded/non-critical | backlog triage | Dev | TODO | Optional |
| SEV-4 | Cosmetic/docs | backlog | Owner | TODO | Optional |
