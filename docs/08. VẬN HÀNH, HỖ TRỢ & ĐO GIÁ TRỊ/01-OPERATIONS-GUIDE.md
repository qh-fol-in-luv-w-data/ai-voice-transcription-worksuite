...
Tài liệu hóa operations guide cho dự án dựa trên source code hiện tại.
...
|---|---|
| Application health | Frappe web reachable, SPA route opens |
| Queue | long worker processing transcription/extract jobs |
| Redis/cache | progress/status keys reachable |
| Storage | private/public files disk usage, chunk cleanup |
| Logs | Frappe Error Log for STT/AI/ERP errors |
| Provider quotas | OpenAI/Gemini/ElevenLabs balances |
| Scheduled jobs | Verify `cleanup_old_chunks` function issue |
